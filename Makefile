...
DroneTestProject-Linux-Debug:
	 $(PROJECTBUILD) DroneTestProject Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

DroneTestProject-Linux-DebugGame:
	 $(PROJECTBUILD) DroneTestProject Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

DroneTestProject-Linux-Shipping:
	 $(PROJECTBUILD) DroneTestProject Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

DroneTestProject-Linux-Test:
	 $(PROJECTBUILD) DroneTestProject Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

DroneTestProject:
	 $(PROJECTBUILD) DroneTestProject Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

DroneTestProjectEditor-Linux-Debug:
	 $(PROJECTBUILD) DroneTestProjectEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

DroneTestProjectEditor-Linux-DebugGame:
	 $(PROJECTBUILD) DroneTestProjectEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

DroneTestProjectEditor-Linux-Shipping:
	 $(PROJECTBUILD) DroneTestProjectEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

DroneTestProjectEditor-Linux-Test:
	 $(PROJECTBUILD) DroneTestProjectEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

DroneTestProjectEditor:
	 $(PROJECTBUILD) DroneTestProjectEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
