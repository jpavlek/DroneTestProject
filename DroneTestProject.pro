...
unrealRootPath=/home/jpavlek/UnrealEngine4/UnrealEngine
DroneTestProjectRootPath=/home/jpavlek/Projects/cpp/DroneTestProject

gameProjectFile=/home/jpavlek/Projects/cpp/DroneTestProject/DroneTestProject.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(DroneTestProjectSource.pri)
include(DroneTestProjectHeader.pri)
include(DroneTestProjectConfig.pri)
include(DroneTestProjectIncludes.pri)
include(DroneTestProjectDefines.pri)
...
DroneTestProject-Linux-Debug.commands = $$build DroneTestProject Linux Debug  -project="\"$$gameProjectFile\"" $$args
DroneTestProject-Linux-DebugGame.commands = $$build DroneTestProject Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
DroneTestProject-Linux-Shipping.commands = $$build DroneTestProject Linux Shipping  -project="\"$$gameProjectFile\"" $$args
DroneTestProject-Linux-Test.commands = $$build DroneTestProject Linux Test  -project="\"$$gameProjectFile\"" $$args
DroneTestProject.commands = $$build DroneTestProject Linux Development  -project="\"$$gameProjectFile\"" $$args

DroneTestProjectEditor-Linux-Debug.commands = $$build DroneTestProjectEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
DroneTestProjectEditor-Linux-DebugGame.commands = $$build DroneTestProjectEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
DroneTestProjectEditor-Linux-Shipping.commands = $$build DroneTestProjectEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
DroneTestProjectEditor-Linux-Test.commands = $$build DroneTestProjectEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
DroneTestProjectEditor.commands = $$build DroneTestProjectEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	DroneTestProject-Linux-Debug \
	DroneTestProject-Linux-DebugGame \
	DroneTestProject-Linux-Shipping \
	DroneTestProject-Linux-Test \
	DroneTestProject \
	DroneTestProjectEditor-Linux-Debug \
	DroneTestProjectEditor-Linux-DebugGame \
	DroneTestProjectEditor-Linux-Shipping \
	DroneTestProjectEditor-Linux-Test \
	DroneTestProjectEditor \
